// CoinSoul Charts JavaScript Module
...
window.coinSoulCharts.renderDailyPnl = function(labels, values) {
    ...
    console.log('[CoinSoulCharts] Daily PnL chart rendered successfully');
};

// Additional chart functions can be added here
window.coinSoulCharts.renderEquity = function(labels, values) {
    // TODO: Implement equity chart if needed
    console.log('[CoinSoulCharts] Equity chart placeholder');
};// CoinSoul Charts JavaScript Module
window.coinSoulCharts = window.coinSoulCharts || {};
window.coinSoulCharts._chartDaily = null;
